...
const basePath = '/cnno-1776323767628';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver exceptional, artisanal sweet rolls that nurture both body and soul, while building a community that shares our passion for comfort, quality, and warmth.</p>
                </div>
                <div className="space-y-2">
